...
public class ExchangeTree extends DefaultTreeModel {
    ...
    /**
     * Constructor for server.ExchangeTree
     * @param root  root node
     * @param info  server.Server's public information (base and mod)
     */
    public ExchangeTree(ExchangeTreeNode root, int[] info)
    {
        ...
        lockAll(root);
        // Create Tree; distribute server.Server ExchangeThreads to branches and leaves
     ...
     * Make sure private key never passes through server.Server side.
     * @param inf   information to process
