...
public class Matrices {
     ...
     * @return      AxC matrix
     */
    public float[][] matrixMultiply(float[][] mat1, float[][] mat2)
    {
        int retx      = getX(mat2);
        int rety      = getY(mat1);
     ...
     */
    public float[][] scalarMultiply(float[][] mat, float s)
    {
        int x         = getX(mat);
        int y         = getY(mat);
     ...
     */
    public float[][] scalarDivide(float[][] mat, float s)
    {
        int x         = getX(mat);
        int y         = getY(mat);
        float[][] ret = new float[x][y];
     ...
     */
    public float[][] modMat(float[][] mat, float mod)
    {
        int x         = getX(mat);
        int y         = getY(mat);
        float[][] ret = new float[x][y];
     ...
     */
    public float[][] extModMat(float[][] mat, float mod)
    {
        mat      = modMat(mat, mod);
        int matx = getX(mat);
        int maty = getY(mat);
     ...
     */
    public float[][] getMatMinors(float[][] mat)
    {
        int dim       = mat.length;
     ...
     */
    public float[][] getMatCofactors(float[][] mat)
    {
        int dim          = mat.length;
        float[][] ret    = new float[dim][dim];
     ...
     */
    public float[][] matModInv(float[][] mat)
    {
        float det     = getDet(mat);
     ...
     */
    public float[][][] transformTextToMat(String text)
    {
        int a = text.length() / 3;
     ...
     */
    public String transformMatToText(float[][] mat)
    {
        String s = "";
     ...
     */
    public float[][] generateKey(int dimension)
    {
        float det = 0;
     ...
     */
    public float[] getRow(float[][] mat, int y)
    {
     ...
     */
    public float[] getCol(float[][] mat, int x)
    {
        float[] ret = mat[x];
        return ret;
    }
     ...
     */
    public float[][] setRow(float[][] mat, float[] row, int y)
    {
        for (int i = 0; i < mat.length; i++)
        {
            mat[i][y] = row[i];
     ...
     */
    public float[][] setCol(float[][] mat, float[] col, int x)
    {
        mat[x] = col;
        return mat;
    }
     ...
     */
    public void printMat(float[][] mat)
    {
     ...
     */
    public void printRow(float[][] mat, int y)
    {
     ...
     */
    public int modInv(int co, int mod)
    {
        boolean found = false;
        int mult      = 0;
        int com       = co;
